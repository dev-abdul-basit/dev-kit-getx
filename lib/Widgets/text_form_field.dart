...
class CommonTextFormField extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return TextFormField(
      ...
      cursorColor: AppColor.colorPrimaryLightGreen,
      style: TextStyle(
...
class CommonTextFormFieldWithSuffix extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    final focusedBorder = OutlineInputBorder(
      ...
      borderSide: BorderSide(color: Get.theme.colorScheme.onPrimary, width: 0.5),
    );
    final enabledBorder = OutlineInputBorder(
      borderRadius: borderRadius,
      borderSide:
          BorderSide(color: Get.theme.colorScheme.surfaceTint, width: 0.5),
    );
    ...
    return TextFormField(
      ...
      decoration: InputDecoration(
          ...
          //                 start: AppSizes.width_5,
          //                 end: AppSizes.width_2_8,
          //                 top: 0,
          //                 bottom: AppSizes.height_9),
          //             // child: Image.asset(
          //             //   prefixIcon,
          ...
          //             : Container(
          //                 margin: EdgeInsetsDirectional.only(
          //                     start: AppSizes.width_5_5,
          //                     end: AppSizes.width_3,
          //                     top: AppSizes.height_1,
