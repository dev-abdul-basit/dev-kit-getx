...
import 'package:get_template/Widgets/common_button_one.dart';
import 'package:get_template/Widgets/common_button_with_image.dart';
          ...
          child: Column(
            ...
            children: [
              ...
              if (image == null)
                Container(
                  ...
                  child: Image.asset(Assets.assetsSplashscreen,
                      height: AppSizes.height_6, width: AppSizes.height_6),
                ),
              if (image != null)
                Image.asset(
                  image!,
              ...
              CommonText(
                  ...
                  textAlign:
                      isSubscription ? TextAlign.start : TextAlign.center,
              ...
              isSubscription
                ...
                iconColor: Get.theme.colorScheme.primary,
                      onTap: onTapDelete,
                      icon: Assets.assetsSplashscreen,
